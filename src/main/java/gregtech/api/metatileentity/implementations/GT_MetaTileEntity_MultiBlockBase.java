...
//		}
    ...
    public String[] getInfoData() {
        return new String[]{trans2(0, "Progress:"), (mProgresstime / 20) + trans2(1, "secs"), (mMaxProgresstime / 20) + trans2(1, "secs"), trans2(2, "Efficiency:"), (mEfficiency / 100.0F) + "%", trans2(3, "Problems:"), String.valueOf((getIdealStatus() - getRepairStatus()))};
    }
