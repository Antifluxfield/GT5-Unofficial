...
public class GT_MetaTileEntity_Hatch_Muffler extends GT_MetaTileEntity_Hatch {
    ...
    public String[] getDescription() {
        ...
        desc[mDescriptions.length] = "DO NOT OBSTRUCT THE OUTPUT!";
        desc[mDescriptions.length + 1] = "Reduces Pollution to %%%" + calculatePollutionReduction(100) + "%";
        return desc;
    }
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_Hatch_Muffler(mName, mTier, mDescriptions, mTextures);
    }
