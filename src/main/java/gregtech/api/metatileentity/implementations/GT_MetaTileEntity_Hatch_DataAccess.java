...
public class GT_MetaTileEntity_Hatch_DataAccess extends GT_MetaTileEntity_Hatch {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_Hatch_DataAccess(mName, mTier, mDescriptions, mTextures);
    }
    ...
    public Object getServerGUI(int aID, InventoryPlayer aPlayerInventory, IGregTechTileEntity aBaseMetaTileEntity) {
    	switch (mTier) {
    	case 4:
    		return new GT_Container_2by2_DataAccess(aPlayerInventory, aBaseMetaTileEntity);
    	default:
    		return new GT_Container_4by4_DataAccess(aPlayerInventory, aBaseMetaTileEntity);
    	}
    }
    ...
    public Object getClientGUI(int aID, InventoryPlayer aPlayerInventory, IGregTechTileEntity aBaseMetaTileEntity) {
    	switch (mTier) {
    	case 4:
    		return new GT_GUIContainer_2by2(aPlayerInventory, aBaseMetaTileEntity, new GT_Container_2by2_DataAccess(aPlayerInventory, aBaseMetaTileEntity), "Data Access Hatch", "DataAccess");
    	case 6:
    		return new GT_GUIContainer_4by4(aPlayerInventory, aBaseMetaTileEntity, new GT_Container_4by4_DataAccess(aPlayerInventory, aBaseMetaTileEntity), "Data Access Hatch", "DataAccess");
    	default:
    		return new GT_GUIContainer_4by4(aPlayerInventory, aBaseMetaTileEntity, new GT_Container_4by4_DataAccess(aPlayerInventory, aBaseMetaTileEntity), "Data Access Hatch", "DataAccess");
    	}
    }
