...
public class GT_GUIContainer_3by3 extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_3by3(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity, GT_ContainerMetaTile_Machine aContainer, String aName, String aBackground) {
        super(aContainer, RES_PATH_GUI + aBackground + "3by3.png");
        mName = aName;
    }
