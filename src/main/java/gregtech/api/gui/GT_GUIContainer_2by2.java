...
public class GT_GUIContainer_2by2 extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_2by2(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity, GT_ContainerMetaTile_Machine aContainer, String aName, String aBackground) {
        super(aContainer, RES_PATH_GUI + aBackground + "2by2.png");
        mName = aName;
    }
