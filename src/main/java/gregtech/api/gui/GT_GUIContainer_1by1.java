...
public class GT_GUIContainer_1by1 extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_1by1(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity, GT_ContainerMetaTile_Machine aContainer, String aName, String aBackground) {
        super(aContainer, RES_PATH_GUI + aBackground + "1by1.png");
        mName = aName;
    }
