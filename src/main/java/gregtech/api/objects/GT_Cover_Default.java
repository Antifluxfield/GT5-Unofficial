...
public class GT_Cover_Default extends GT_CoverBehavior {
    ...
    public int onCoverScrewdriverclick(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity, EntityPlayer aPlayer, float aX, float aY, float aZ) {
        ...
        GT_Utility.sendChatToPlayer(aPlayer, ((aCoverVariable & 1) != 0 ? trans(48, "Redstone") + " " : "") + ((aCoverVariable & 2) != 0 ? trans(49, "Energy") + " " : "") + ((aCoverVariable & 4) != 0 ? trans(50, "Fluids") + " " : "") + ((aCoverVariable & 8) != 0 ? trans(51, "Items") + " " : ""));
