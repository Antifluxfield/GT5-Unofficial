...
public class GT_GUIContainer_MicrowaveEnergyTransmitter
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        this.fontRendererObj.drawString(trans(134, "Microwave Energy Transmitter"), 46, 8, 16448255);
        if (this.mContainer != null) {
            ...
            if (((GT_Container_MicrowaveEnergyTransmitter) this.mContainer).mEgg > 0) {
                this.fontRendererObj.drawString(trans(133, "Dim: ") + GT_Utility.parseNumberToString(((GT_Container_MicrowaveEnergyTransmitter) this.mContainer).mTargetD), 46, 40, 16448255);
            }
        }
    }
