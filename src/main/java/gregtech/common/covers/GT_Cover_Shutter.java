...
public class GT_Cover_Shutter
    ...
    public int onCoverScrewdriverclick(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity, EntityPlayer aPlayer, float aX, float aY, float aZ) {
        ...
        switch(aCoverVariable) {
            case 0: GT_Utility.sendChatToPlayer(aPlayer, trans(93, "Open if work enabled")); break;
            case 1: GT_Utility.sendChatToPlayer(aPlayer, trans(94, "Open if work disabled")); break;
            case 2: GT_Utility.sendChatToPlayer(aPlayer, trans(95, "Only Output allowed")); break;
            case 3: GT_Utility.sendChatToPlayer(aPlayer, trans(96, "Only Input allowed")); break;
        }
        return aCoverVariable;
    }
