...
public class GT_Cover_PlayerDetector extends GT_CoverBehavior {
    ...
    public int onCoverScrewdriverclick(byte aSide, int aCoverID, int aCoverVariable, ICoverable aTileEntity, EntityPlayer aPlayer, float aX, float aY, float aZ) {
        ...
        switch(aCoverVariable) {
            case 0: GT_Utility.sendChatToPlayer(aPlayer, trans(80, "Emit if any Player is close")); break;
            case 1: GT_Utility.sendChatToPlayer(aPlayer, trans(81, "Emit if you are close")); break;
            case 2: GT_Utility.sendChatToPlayer(aPlayer, trans(82, "Emit if other player is close")); break;
        }
        return aCoverVariable;
    }
