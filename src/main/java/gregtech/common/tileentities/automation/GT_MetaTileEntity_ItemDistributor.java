...
public class GT_MetaTileEntity_ItemDistributor extends GT_MetaTileEntity_Buffer {
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
		return new GT_MetaTileEntity_ItemDistributor(this.mName, this.mTier, this.mInventory.length, this.mDescriptions, this.mTextures);
	}
	...
	public void onScrewdriverRightClick(byte aSide, EntityPlayer aPlayer, float aX, float aY, float aZ) {
		...
		GT_Utility.sendChatToPlayer(aPlayer, trans(47, "Items per side: ") + itemsPerSide[aSide]);
	}
