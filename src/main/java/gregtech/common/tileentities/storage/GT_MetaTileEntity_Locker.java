...
public class GT_MetaTileEntity_Locker
    ...
    public String[] getDescription() {
        ...
        desc[mDescriptions.length] = "Click with Screwdriver to change Style";
        return desc;
    }
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_Locker(this.mName, this.mTier, this.mDescriptions, this.mTextures);
    }
